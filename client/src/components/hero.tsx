...
export default function Hero() {
  return (
    <section className="relative w-full h-[74svh] min-h-[500px] bg-brand-ivory overflow-hidden md:h-screen">
      ...
      <div className="relative z-10 h-full flex flex-col justify-end items-center text-center px-5 pb-10 md:justify-center md:px-6 md:pb-0">
        <motion.div
